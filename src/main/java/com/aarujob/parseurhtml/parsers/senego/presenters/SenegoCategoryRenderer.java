...
/**
 * transforms a category element of Senego website into CategoryModel object
 *
 * @author smag
 * @version 1.0.0
 */
public class SenegoCategoryRenderer extends CategoryRenderer {

    /**
     * <b>Constructor</b>
     *
     * @param element corresponds to a catergory html of Senego website
     * @param isHome is true when article comes from home page
     * @param name the name of website
     */
    public SenegoCategoryRenderer(Element element, String name) {
        super(element, name);
    }
