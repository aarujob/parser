...
/**
 * retrieves all articles in an element html which has provided by Senego
 * website
 *
 * @author smag
 * @version 1.0.0
 */
public class SenegoArticleSeeker extends ArticleSeeker {

    /**
     * <b>Constructor</b>
     *
     * @param element references element html retrieved in Senego website
     * @param isHome is true when the element comes from homepage
     * @param name the name of website
     */
    public SenegoArticleSeeker(Element element, boolean isHome, String name) {
