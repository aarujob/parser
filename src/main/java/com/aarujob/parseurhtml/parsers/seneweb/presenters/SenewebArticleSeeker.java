...
/**
 * retrieves all articles in an element html which has provided by seneweb
 * website
 *
 * @author smag
 * @version 1.0.0
 */
public class SenewebArticleSeeker extends ArticleSeeker {
     ...
     */
    public SenewebArticleSeeker(Element element, boolean isHome, String name) {
