...
/**
 * transforms a category element of Xibar website into CategoryModel object
 *
 * @author smag
 * @version 1.0.0
 */
public class XibarCategoryRenderer extends CategoryRenderer {

    /**
     * <b>Constructor</b>
     *
     * @param element corresponds to a catergory html of Xibar website
     * @param isHome  is true when article comes from home page
     * @param name    the name of website
     */
    public XibarCategoryRenderer(Element element, String name) {
        super(element, name);
    }
