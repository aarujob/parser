...
/**
 * transforms a category element of seneweb website into CategoryModel object
 *
 * @author smag
 * @version 1.0.0
 */
public class SenewebCategoryRenderer extends CategoryRenderer {

    /**
     * <b>Constructor</b>
     *
     * @param element corresponds to a catergory html of seneweb website
     * @param isHome is true when article comes from home page
     * @param name the name of website
     */
    public SenewebCategoryRenderer(Element element, String name) {
        super(element, name);
    }
