...
/**
 * retrieves all articles in an element html which has provided by Leral
 * website
 *
 * @author smag
 * @version 1.0.0
 */
public class LeralArticleSeeker extends ArticleSeeker {
     ...
     */
    public LeralArticleSeeker(Element element, boolean isHome, String name) {
